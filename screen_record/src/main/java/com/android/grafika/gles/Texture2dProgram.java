...
public class Texture2dProgram {
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        KLog.d(TAG, "Created program " + mProgramHandle + " (" + programType + ")");
     ...
     */
    public void release() {
        KLog.d(TAG, "deleting program " + mProgramHandle);
    ...
    public void setKernel(float[] values, float colorAdj) {
        ...
        //KLog.d(TAG, "filt kernel: " + Arrays.toString(mKernel) + ", adj=" + colorAdj);
    }
    ...
    public void setTexSize(int width, int height) {
        ...
        //KLog.d(TAG, "filt size: " + width + "x" + height + ": " + Arrays.toString(mTexOffset));
    }
